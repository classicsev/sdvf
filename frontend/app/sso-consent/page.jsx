      ...
      <div className="fp-login-page">
        <div className="fp-login-card" style={{ textAlign: "center" }}>
          ...
          <div className="fp-spam-hint">
            Письмо, скорее всего, попадёт в папку «Спам» — это обычное дело для нового почтового
            отправителя. Проверьте её и пометьте письмо как «Не спам», чтобы следующие письма
            приходили нормально.
          </div>
        </div>
      </div>
